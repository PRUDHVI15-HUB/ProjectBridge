        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {services.map((item, index) => {
            ...
            return (
              <div
                key={index}
                className="bg-white border border-slate-200/90 rounded-xl p-8 hover:border-indigo-300 hover:shadow-md transition card-hover flex flex-col justify-between h-44 sm:h-48 group cursor-default"
              >
